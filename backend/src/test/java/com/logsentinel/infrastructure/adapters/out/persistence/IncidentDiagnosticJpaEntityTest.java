...
class IncidentDiagnosticJpaEntityTest {
    ...
    void should_be_equal_to_itself() {
        var entity = new IncidentDiagnosticJpaEntity(UUID.randomUUID(), "Root cause: pool exhaustion.");
    ...
    void should_not_be_equal_when_both_ids_are_null() {
        ...
        var first = new IncidentDiagnosticJpaEntity(incidentId, "Root cause: pool exhaustion.");
        var second = new IncidentDiagnosticJpaEntity(incidentId, "Root cause: pool exhaustion.");
    ...
    void hash_code_should_be_consistent_across_instances() {
        var first = new IncidentDiagnosticJpaEntity(UUID.randomUUID(), "Root cause: pool exhaustion.");
        var second = new IncidentDiagnosticJpaEntity(UUID.randomUUID(), "A different diagnostic text.");
    ...
    void should_map_to_domain_incident_diagnostic() {
        UUID incidentId = UUID.randomUUID();
        var entity = new IncidentDiagnosticJpaEntity(incidentId, "Root cause: connection pool exhaustion detected.");
